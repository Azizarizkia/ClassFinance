...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="assets/img/img_properties/logo.png" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">ClassFinance
    </span>
  </a>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <div class="bg-success nav-link text-white">
            ...
            <?php
            $sisa_uang= $jml_uang_kas - $jml_pengeluaran;
            // if ($jml_uang_kas > $sisa_uang)
            // setAlert("Jumlah pengeluaran lebih besar dari jumlah uang", "Gagal menambahkan", "Gagal");
            ?>
            <p>
              Sisa Uang: <?= number_format($sisa_uang)?>
            </p>
          </div>
        </li>
        <li class="nav-item has-treeview menu-open">
