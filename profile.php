<?php 
  ...
  if (isset($_POST['btnEditProfile'])) {
  	if (editUser($_POST) > 0) {
  		setAlert("Profile Anda Telah Diubah", "Berhasil diubah", "Berhasil");
  ...
  if (isset($_POST['btnChangePassword'])) {
  	if (changePassword($_POST) > 0) {
  		setAlert("Password Anda Telah Diubah", "Berhasil diubah", "Berhasil");
		header("Location: profile.php");
  	}
  }
?>
		    ...
		    <form method="post">
		    	...
		    	<div class="modal-content">
			      ...
			      <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="new_password_verify">Password Verifikasi</label>
