  ...
  if (isset($_POST['btnLogin'])) {
  	...
  	if ($data = mysqli_fetch_assoc($checkUsername)) {
  		if (password_verify($password, $data['password'])) {
			...
			setAlert("Password yang Anda masukan salah!", "Periksan Password Anda kembali!", "error");
			header("Location: login.php");
	  	}
  	} else {
		setAlert("Username tidak terdaftar!", "Periksan Username Anda kembali!", "error");
		header("Location: login.php");
  	}
  }
?>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-4 mx-5 py-4 px-5 text-dark rounded border border-dark" style="background-color: rgba(180,190,196,.6);">
				<h3 class="text-center">ClassFinance</h3>
				<form method="post" autocomplete="off">
					...
					<div class="form-group text-right">
						<button class="btn btn-success rounded-pill" name="btnRegister"><i class="fas fa-fw fa-sign-in-alt"></i><a href="/uangAziza/ClassFinance/register.php" style="color:white;"> Register</a> </button>
