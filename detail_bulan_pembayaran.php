<?php 
  ...
  if (isset($_POST['btnTambahSiswa'])) {
    if (tambahSiswaUangKas($_POST) > 0) {
      setAlert("Siswa telah ditambahkan", "Berhasil ditambahkan", "Berhasil");
      header("Location: detail_bulan_pembayaran.php?id_bulan_pembayaran=$id_bulan_pembayaran");
    }
  }
          ...
          <table class="table table-hover table-striped table-bordered" id="table_id">
            ...
            <tbody>
              ...
              <?php foreach ($uang_kas as $duk): ?>
                ...
                <?php else: ?>
                  <?php if ($id_bulan_pembayaran != $id_bulan_pembayaran_pertama AND isset($data_bulan_sebelum['status_lunas']) AND $data_bulan_sebelum['status_lunas'] == '0'): ?>
                    <tr class="bg-danger">
                  <?php else: ?>
                    <tr>
                  <?php endif ?>
...
<?php endif ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 By Aziza Arizkia Ramashani.</strong>
    All rights reserved.
