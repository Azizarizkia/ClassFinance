<?php 
  ...
  if (isset($_POST['btnEditUser'])) {
    if (editUser($_POST) > 0) {
      setAlert("User telah diubah", "Berhasil diubah", "Berhasil");
      header("Location: user.php");
    } else {
      setAlert("User Gagal Untuk Diubah!", "Gagal diubah!", "error");
      header("Location: user.php");
    }
  }
  ...
  if (isset($_POST['btnTambahUser'])) {
    if (addUser($_POST) > 0) {
      setAlert("User telah ditambahkan", "Berhasil ditambahkan", "Berhasil");
      header("Location: user.php");
    }
  }
?>
