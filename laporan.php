...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
        	...
        	<div class="row m-1">
				...
				<div class="bagian-atas" style="display:flex;">
					<img style="width:250px;margin-right:30px;"src="assets/img/img_properties/Tels.png"/>
						<div class="description" style="text-align: center; margin-left:50px; ">
							<h2 style="display:block; text-transform:harder; font-size:40px">SMK TELEKOMUNIKASI TELESANDI</h2>
							<h5>BIDANG KEAHLIAN TEKNOLOGI INFORMASI DAN KOMUNIKASI</h5>
							<p style="font-size: large;">Mekarsari Raya, Jl. KH. Mochammad, Mekarsari-Tambun Selatan</p>
							<p style="font-size: large;">Kabupaten Bekasi Jawa Barat 17510</p>
							<p >Telepon (021) 88332404, Fax. (021) 88323429</p>
							<p style="font-size: large;">Email: telesandismk@gmail.com, Website: www.smktelekomunikasitelesandi.sch.id</p>
						</div>
					</div>
					<br/>
	        					...
	        					<?php foreach ($sql as $ds): ?>
	        						<tr>
	        							...
	        							<?php if ($ds['minggu_ke_1'] == $ds['pembayaran_perminggu']): ?>
					                      <td class="text-success"><?= $tanggal?></td>
					                    <?php else: ?>
	        	...
	        	<div class="col-lg m-1">
					...
					<img style="width:250px;margin-right:30px;"src="assets/img/img_properties/Tels.png"/>
						<div class="description" style="text-align: center; margin-left:50px; ">
							...
							<p style="font-size: large;">Mekarsari Raya, Jl. KH. Mochammad, Mekarsari-Tambun Selatan</p>
							<p style="font-size: large;">Kabupaten Bekasi Jawa Barat 17510</p>
							<p style="font-size: large;">Telepon (021) 88332404, Fax. (021) 88323429</p>
							<p style="font-size: large;">Email: telesandismk@gmail.com, Website: www.smktelekomunikasitelesandi.sch.id</p>
						</div>
					</div>
					<br/>
	  ...
	  <div class="tandatangan" style="margin-left:85%;">
	  <p>......., ......... 20  </p>
	  <br><br><br>
	  <p>( ................... )</p>
	  </div>
